<ul class="navbar-nav">
  <?php if ($_SESSION['level'] == 'admin') { ?>
    ...
    <li class="nav-item">
      <a class="nav-link  active" href="http://<?= $_SERVER['SERVER_NAME'] ?>/pengaduan_masyarakat_peno/UKK-2023/modul/modul-profile/">
    ...
    <li class="nav-item">
      <a class="nav-link  " href="http://<?= $_SERVER['SERVER_NAME'] ?>/pengaduan_masyarakat_peno/UKK-2023/modul/modul-pengaduan/">
        <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
          <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>table</title>
    ...
    <li class="nav-item">
      <a class="nav-link  " href="http://<?= $_SERVER['SERVER_NAME'] ?>/pengaduan_masyarakat_peno/UKK-2023/modul/modul-tanggapan">
        <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
          <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>wallet</title>
    ...
    <li class="nav-item border-start my-0 pt-2">
      <a class="nav-link position-relative ms-0 ps-2 py-2 " href="http://<?= $_SERVER['SERVER_NAME'] ?>/pengaduan_masyarakat_peno/UKK-2023/modul/modul-petugas">
        <span class="nav-link-text ms-1">Petugas</span>
      </a>
    </li>
    <li class="nav-item border-start my-0 pt-2">
      <a class="nav-link position-relative ms-0 ps-2 py-2 " href="http://<?= $_SERVER['SERVER_NAME'] ?>/pengaduan_masyarakat_peno/UKK-2023/modul/modul-masyarakat">
        <span class="nav-link-text ms-1">Masyarakat</span>
      </a>
    </li>
    <li class="nav-item border-start my-0 pt-2">
      <a class="nav-link position-relative ms-0 ps-2 py-2 " href="http://<?= $_SERVER['SERVER_NAME'] ?>/pengaduan_masyarakat_peno/UKK-2023/modul/modul-auth/logout.php">
