    ...
    <nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-2">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bold mb-0">Masyarakat</h6>
        </nav>
          ...
          <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                <div>
                  <h6 class="font-weight-semibold text-lg mb-0">Masyarakat list</h6>
                  <p class="text-sm">See information about all Masyarakat</p>
                </div>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="dataTablesNya">
                  <thead class="bg-gray-100">
                    <tr>
                      <th class="text-secondary text-center text-xs font-weight-semibold opacity-7">NIK</th>
                      <th class="text-secondary text-xs text-center font-weight-semibold opacity-7 ps-2">Nama</th>
                  ...
                  <?php
										...
										while ($d = mysqli_fetch_object($q)) { ?>
											<tr>
												<td>
                        <h6 class="mb-0 text-sm text-center font-weight-semibold"><?= $d->nik ?></h6>
													
												</td>
												<td>
                        <h6 class="mb-0 text-sm text-center font-weight-semibold"><?= $d->nama ?></h6>
