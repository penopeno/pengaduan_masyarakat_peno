    ...
    <nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-2">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bold mb-0">Tanggapan</h6>
        </nav>
          ...
          <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                <div>
                  <h6 class="font-weight-semibold text-lg mb-0">Tanggapan list</h6>
                  <p class="text-sm">See information about all Tanggapan</p>
                </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="dataTablesNya">
                  <thead class="bg-gray-100">
                    <tr>
                      <th class="text-secondary text-xs text-center font-weight-semibold opacity-7">ID Pengaduan</th>
                      <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Tanggal Pengaduan</th>
                      <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">Isi Tanggapan</th>
                      <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">Petugas</th>
                      <?php if ($_SESSION['level'] == 'petugas') { ?>
                  ...
                  <tbody>
                    ...
                    while ($d = mysqli_fetch_object($r)) { ?>
                      <tr>
                        ...
                        <td>
                          <h6 class="mb-0 text-center text-sm font-weight-semibold"><?= $d->id_pengaduan ?></h6>
                        </td>
                        <td>
                        <h6 class="mb-0 text-sm font-weight-semibold"><?= $d->tgl_tanggapan ?></h6>

                          
                        </td>
                        <td>
                        <h6 class="mb-0 text-center text-sm font-weight-semibold"><?= $d->tanggapan ?></h6>
                        ...
                        <?php if ($_SESSION['level'] == 'petugas') { ?>
                          <td class="mb-0 text-center text-sm font-weight-semibold">
